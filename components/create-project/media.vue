<template>
  <div class="flex flex-col gap-6">
    <div
      ref="dropZoneRef"
      class="flex flex-col gap-4 rounded-2xl border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900/70 p-6 shadow-sm cursor-pointer hover:opacity-85 transition-all hover:transition-all"
      @dragover.prevent
    ...
    <div
      ...
      class="rounded-2xl border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900/70 p-6 shadow-sm"
    >
...
// Sync local files with global state
const files = computed({
  get: () => state.value.media,
  set: (value) => {
    state.value.media = value;
  },
});
