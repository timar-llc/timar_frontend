<template>
  ...
  >
    <template #body>
      ...
      <div
        class="flex bg-card-bg p-4 border border-gray-300 rounded-lg dark:border-gray-600 gap-3"
      >
        <UIcon name="i-lucide-clock" class="w-6 h-6 text-success" />
        <div class="flex flex-col">
          <h3 class="text-sm text-success">
